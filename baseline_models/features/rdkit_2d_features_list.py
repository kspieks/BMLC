...
RDKIT_PROPS = {
    ...
    # v1.1.0 is identical to v1.0.0 except it removes Ipc because
    # <function rdkit.Chem.GraphDescriptors.Ipc(mol, avg=0, dMat=None, forceDMat=0)>
	# gives extremely large values for big molecules and the effect on models is likely negligible
    "1.1.0": ['BalabanJ', 'BertzCT', 'Chi0', 'Chi0n', 'Chi0v', 'Chi1', 'Chi1n',        
              'Chi1v', 'Chi2n', 'Chi2v', 'Chi3n', 'Chi3v', 'Chi4n', 'Chi4v',
              'EState_VSA1', 'EState_VSA10', 'EState_VSA11', 'EState_VSA2',
              'EState_VSA3', 'EState_VSA4', 'EState_VSA5', 'EState_VSA6',
              'EState_VSA7', 'EState_VSA8', 'EState_VSA9', 'ExactMolWt',
